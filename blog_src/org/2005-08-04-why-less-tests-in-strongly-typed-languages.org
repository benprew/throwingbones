#+TITLE: Why Less Tests In Strongly Typed Languages
#+AUTHOR: Ben
#+DATE: 2005-08-04
#+TAGS: testing software-development reading meta
...
tests is not a requirement for high-quality software, but that's not the
point...\\
\\
...
fixing a "broken" compiler? Is the compiler that broken to begin with?\\
\\
