...
For example, why did Matz write Ruby? It has a lot of concepts that lisp employs, but its significantly slower. Between inventing ruby and just using lisp, [[http://blade.nagaokaut.ac.jp/cgi-bin/scat.rb/ruby/ruby-talk/179642][why didn't Matz just use lisp, or smalltalk?]]
...
Note, I think my arguments are implicitly supported by Steve Yegge's [[http://steve-yegge.blogspot.com/2006/04/lisp-is-not-acceptable-lisp.html][blog post about why lisp in an unacceptable lisp]]. Its not that the points brought up were technically sound, but rather that they represent the kind of problem I'm talking about; things behaved differently then he had come to expect from most "mainstream" languages.
