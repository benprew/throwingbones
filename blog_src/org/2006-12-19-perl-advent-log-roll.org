#+TITLE: Perl Advent Log Roll
#+AUTHOR: Ben
#+DATE: 2006-12-19
#+TAGS: technology

Over the Christmas holiday I wrote a few posts for the Perl advent calendar. I'd like to share them here, if only for posterity. I believe you should be able to view the [[http://perladvent.pm.org/2006/17/][archived original]].
